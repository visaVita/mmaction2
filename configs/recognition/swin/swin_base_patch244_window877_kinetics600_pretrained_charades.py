...
model=dict(backbone=dict(
           ...
           cls_head=dict(
               num_classes=157, 
               multi_class=True, 
               loss_cls=dict(type='AsymmetricLossOptimized'),
               ), 
...
load_from = ('https://github.com/SwinTransformer/storage/releases/'
             'download/v1.0.4/swin_base_patch244_window877_kinetics600_22k.pth')

...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            # TranSTL param
            # 'cls_head.base_cls': dict(lr_mult=2.),
...
work_dir = './work_dirs/k600_swin_base_22k_patch244_window877_tranST_charades_finetune'
...
log_level = 'INFO'
load_from = ('work_dirs/k600_swin_base_22k_patch244_window877_freeze_backbone_charades/enc2_stld2_20e_map2491_nofinetune.pth')
resume_from = None
workflow = [('train', 1)]
omnisource = False
module_hooks = []

...
data['test'] = data['val']
# optimizer
# optimizer = dict(type='SGD', lr=0.05, momentum=0.9, weight_decay=0.00001,
#                  paramwise_cfg=dict(custom_keys={'bbox_head': dict(decay_mult=10.)})
#             )
optimizer = dict(type='AdamW', lr=0.0005, betas=(0.9, 0.999), weight_decay=0.001,)
                #  paramwise_cfg=dict(custom_keys={'backbone': dict(decay_mult=0.1)}))

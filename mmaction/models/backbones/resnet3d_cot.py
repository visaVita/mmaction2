...
@BACKBONES.register_module()
class ResNet3dLayer_CoT(nn.Module):
    """ResNet 3d Layer.
    ...
    def __init__(self,
        ...
        super().__init__()
        self.arch_settings = ResNet3d_CoT.arch_settings
        assert depth in self.arch_settings

        self.make_res_layer = ResNet3d_CoT.make_res_layer
        self._inflate_conv_params = ResNet3d_CoT._inflate_conv_params
        self._inflate_bn_params = ResNet3d_CoT._inflate_bn_params
        self._inflate_weights = ResNet3d_CoT._inflate_weights
        self._init_weights = ResNet3d_CoT._init_weights
...
if mmdet_imported:
    MMDET_SHARED_HEADS.register_module()(ResNet3dLayer_CoT)
    MMDET_BACKBONES.register_module()(ResNet3d_CoT)
